                            ...
                            rolePlayRecommended:
                              ...
                              dispatchRuntimeEvent(
                                                      ...
                                                      emitEyeContactSummary() {
                                                        if(this.eyeContactSamples<8)return;
                                                        const summary=this.buildEyeContactSummary();
                                                        this.eyeContactLastSummaryAt=Date.now();
                                                        this.dispatchRuntimeEvent("nexivra-visual-engagement-summary",summary);
