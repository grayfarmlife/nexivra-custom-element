                                                                                                        ...
                                                                                                        class NexivraLiveAvatar extends HTMLElement {
                                                                                                          ...
                                                                                                          constructor() {
                                                                                                            ...
                                                                                                            // M5B-2N — clean Pedro→learner floor boundary.
                                                                                                            ...
                                                                                                            // M5B-3D.1 — instructor-floor quarantine + session learner continuity.
                                  ...
                                  setTimeout(()=>{if(!this.rolePlayActive){this.rolePlayGatewayLocked=false;console.log("NEXIVRA FORMAL ROLE PLAY GATEWAY REARMED");}},4100);
                                                                                  ...
                                                                                  dispatchRuntimeEvent(
                                                                                                      ...
                                                                                                      hardReleaseLocalMedia(reason="session_end") {
                                                                                                        ...
                                                                                                        console.log("NEXIVRA HARD MEDIA RELEASE COMPLETE:",reason);
                                                                                                            ...
                                                                                                            try {
                                                                                                              ...
                                                                                                              this.session.on(
                                                                                                                ...
                                                                                                                () => {
                                                                                                                  ...
                                                                                                                  // M5B-3D.1 — instructor owns the floor.
                                                                                                                  // Any learner-audio window that begins now is quarantined.
                                                                                                                  this.m5b3d1SpeechBeganDuringInstructor=false;
                                                                                                                ...
                                                                                                                this.guestSession.on(
                                                                                                                  ...
                                                                                                                  () => {
                                                                                                                    ...
                                                                                                                    if(this.m5b2mCompleteAfterPedroSpeaks&&this.rolePlayActive){
                                                                                                                      ...
                                                                                                                      this.m5b2mCompleteAfterPedroSpeaks=false;
                                                                                                                      this.m5b2mCompletionReason="";
                                                                                                                      console.log("NEXIVRA M5B-2N PEDRO FINAL CLOSE COMPLETE — RETURNING TO ELENORA:",completionReason);
                                                                                                                    ...
                                                                                                                    console.log("NEXIVRA M5B-2N PEDRO FINISHED — FRESH LEARNER FLOOR OPEN");
                                                                                                                  }
                                                                                                                );
                                                                                                              } catch(error) {
                                                                                                          ...
                                                                                                          cancelM5B2JLearnerTurnTimer() {
                                                                                                            if(this.m5b2jLearnerTurnTimer){
                                                                                                              clearTimeout(this.m5b2jLearnerTurnTimer);
                                                                                                              this.m5b2jLearnerTurnTimer=null;
                                                                                                            }
                                                                                                          }

                                                                                                          queueM5B2JLearnerFragment(text) {
                                                                                                            const fragment=String(text||"").trim();
                                                                                                            if(!fragment)return;
                                                                                                            this.m5b2jPendingLearnerFragments.push(fragment);
                                                                                                            console.log("NEXIVRA M5B-2N LEARNER FRAGMENT HELD:",{
                                                                                                              fragment,
                                                                                                              fragmentCount:this.m5b2jPendingLearnerFragments.length,
                                                                                                              learnerSpeaking:Boolean(this.learnerMicSpeaking||this.learnerSpeaking),
                                                                                                              pedroSpeaking:Boolean(this.m5b2jPedroSpeaking),
                                                                                                              speechStartToFragmentMs:this.m5b2nLearnerSpeechStartedAtMs
                                                                                                                ? Date.now()-this.m5b2nLearnerSpeechStartedAtMs
                                                                                                                : null
                                                                                                            });
                                                                                                            this.scheduleM5B2JLearnerTurnFlush("transcript_fragment");
                                                                                                          }

                                                                                                          scheduleM5B2JLearnerTurnFlush(reason="silence") {
                                                                                                            this.cancelM5B2JLearnerTurnTimer();
                                                                                                            ...
                                                                                                            this.m5b2jLearnerTurnTimer=setTimeout(()=>{
                                                                                                              ...
                                                                                                              if(this.m5b2jPedroSpeaking||this.learnerMicSpeaking||this.learnerSpeaking){
                                                                                                                this.scheduleM5B2JLearnerTurnFlush("still_busy");
                                                                                                                return;
                                                                                                              }
                                                                                                          ...
                                                                                                          flushM5B2JLearnerTurn(reason="silence_complete") {
                                                                                                            if(!this.rolePlayActive||!this.formalRolePlaySessionId)return;
                                                                                                            if(!this.m5b2nLearnerTurnArmed)return;
                                                                                                            if(this.m5b2jPedroSpeaking||this.learnerMicSpeaking||this.learnerSpeaking)return;
                                                                                                            const fragments=this.m5b2jPendingLearnerFragments.splice(0);
                                                                                                            const text=fragments.join(" ").replace(/\s+/g," ").trim();
                                                                                                            if(!text)return;
                                                                                                            const now=Date.now();
                                                                                                            if(text===this.m5b2jLastFlushedText&&now-Number(this.m5b2jLastFlushedAt||0)<5000){
                                                                                                              console.log("NEXIVRA M5B-2J DUPLICATE COMPLETE TURN IGNORED:",text);
                                                                                                              return;
                                                                                                            }
                                                                                                            ...
                                                                                                            console.log("NEXIVRA M5B-2N COMPLETE LEARNER TURN:",{
                                                                                                              ...
                                                                                                              reason,
                                                                                                              silenceSettleMs:this.m5b2nLearnerAudioStoppedAtMs
                                                                                                                ? now-this.m5b2nLearnerAudioStoppedAtMs
                                                                                                                : null,
                                                                                                              speechStartToTurnMs:this.m5b2nLearnerSpeechStartedAtMs
                                                                                                                ? now-this.m5b2nLearnerSpeechStartedAtMs
                                                                                                                : null
                                                                                                            });
                                                                                                            ...
                                                                                                            try{
                                                                                                              ...
                                                                                                              recognition.onresult=event=>{for(let i=event.resultIndex;i<event.results.length;i++){const result=event.results[i];const text=String(result?.[0]?.transcript||"").trim();if(!text)continue;
                                                                                                                ...
                                                                                                                if(this.m5b3d1LearnerFaceAnchor&&currentAnchor){
                                                                                                                  ...
                                                                                                                  const scaleBase=Math.max(0.0001,Number(this.m5b3d1LearnerFaceAnchor.scale||0.0001));
                                                                                                                  const scaleDelta=Math.abs(Number(currentAnchor.scale)-scaleBase)/scaleBase;
                                                                                                                  learnerContinuity=
                                                                                                                    dx<=Number(this.m5b3d1FaceCenterTolerance||0.24) &&
                                                                                                                    dy<=Number(this.m5b3d1FaceCenterTolerance||0.24) &&
                                                                                                                    scaleDelta<=Number(this.m5b3d1FaceScaleTolerance||0.55);
                                                                                                                }

                                                                                                                const learnerSpeakerSupported=
                                                                                                                  faceVisible &&
                                                                                                                  Boolean(this.m5b3d1FaceVisibleAtSpeechStart) &&
                                                                                                                  mouthActivity &&
                                      ...
                                      if(!this.rolePlayActive){
                                        if(/^(pause|pause session|hold on|just pause)$/.test(globalControlText)){
                                          ...
                                          try{if(typeof this.session?.interrupt==="function")this.session.interrupt();}catch(error){}
                                      ...
                                      this.captureGuestIdentityFromConversation(text);
                                              ...
                                              const isRolePlayControl=
                                                /^(pause|just pause|pause role[- ]?play|pause the role[- ]?play|resume|continue|continue role[- ]?play|resume role[- ]?play)$/.test(rolePlayControlText) ||
                                              ...
                                              if(this.rolePlayActive&&!isRolePlayControl){
                                                if(this.m5b2jPedroSpeaking){
                                                  console.log("NEXIVRA M5B-2N TRANSCRIPT DISCARDED — PEDRO OWNS FLOOR:",text);
                                                  continue;
                                                }
                                                                                                          ...
                                                                                                          async startSession() {
                                                                                                            ...
                                                                                                            if(
                                                                                                              ...
                                                                                                              try{
                                                                                                                ...
                                                                                                                try{if(typeof this.session?.interrupt==="function")await this.session.interrupt();}catch(error){}
                                                                                                                await this.injectRuntimeContext();
                                                                                                                this.m5b3e3SilentStandbyLock=false;
                                                                                                                          ...
                                                                                                                          if(this.rolePlayActive){
                                                                                                                            ...
                                                                                                                            if(!this.m5b2jPedroSpeaking){
                                                                                                                              ...
                                                                                                                              console.log("NEXIVRA M5B-2N LEARNER TURN ARMED — POST-PEDRO SPEECH START:",{
                                                                                                                                floorOpenToSpeechMs:this.m5b2nLearnerFloorOpenedAtMs
                                                                                                                                  ? Date.now()-this.m5b2nLearnerFloorOpenedAtMs
                                                                                                                                  : null
                                                                                                                              });
                                                                                                                            }
                                                                                                                          }
