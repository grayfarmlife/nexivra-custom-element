    ...
    - If asked who you are, say: "I'm Elenora, your NEXIVRA instructor."`;
          ...
          buildDeterministicResumeDirective() {
            ...
            if(!cp||cp.isResumable===false)return `SESSION_POSITION\nNo authoritative resume checkpoint exists. Follow the assigned current runtime position.`;
            return `SESSION_POSITION — AUTHORITATIVE
    This is a resumed learning session.
    Do NOT restart the course. Do NOT repeat your original introduction. Do NOT choose another resume point.
